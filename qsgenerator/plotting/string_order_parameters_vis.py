...
size_9_ids = get_ids([442, 443, 445, 446, 440, 553, 554, 555, 556, 557, 559, 560, 561, 562, 563, 564, 565, 566, 567, 568], id_prefix_wqgans)
metadata = [
...
ax.set_ylabel("String order parameters $S^\mathbb{1}$", fontsize=16)
...
ax.set_xlabel("g", fontsize=16)
ax.set_ylabel("String order parameters $S^{ZY}$", fontsize=16)
